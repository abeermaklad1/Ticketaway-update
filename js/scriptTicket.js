...
function addTicket() {
    ...
    if(userNameInput.value =="" || fromTicketInput.value=="" || toTicketInput.value=="" || fromDateInput.value=="" || phoneInput.value=="" || ticketsInput.value=="" || payInput.value=="")
    {
        // alert("Cann't be empty");
        
    }

    else if(!(phoneInput.value.match(validPhone)))
    {
